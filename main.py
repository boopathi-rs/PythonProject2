...
BALL_WEIGHT_GRAMS = 3.7  # Adjust this to match your actual ball weight
WEIGHT_TOLERANCE = 1.0  # Allow ±1g tolerance per ball
...
def main():
    ...
    calibration_factor = 449.0  # REPLACE with your calibrated value
